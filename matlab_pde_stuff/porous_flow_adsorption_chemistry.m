...
classdef porous_flow_adsorption_chemistry < handle 
    ...
    methods (Access = public)
        ...
        function obj = porous_flow_adsorption_chemistry()
            ...
            obj.refDiff = 2.296E-5/100^2;   % m^2/s
            obj.refDiffTemp = 298.15;       % K
        end
        ...
        function D = DispersionWater(obj, varID, temperature, ux, uy, uz)
            ...
            umag = sqrt(ux.^2 + uy.^2 + uz.^2);
            D = obj.DiffusionWater(varID, temperature) + (umag+5)*obj.alpha;
        end
